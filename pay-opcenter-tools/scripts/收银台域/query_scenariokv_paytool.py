"""
场景KV-支付工具名单 — 查询场景KV支付工具名单列表
来源：schemas/收银台域/v3_场景KV支付工具.json
"""
import sys
import os
...
# 数据展示列（来源：v3_场景KV支付工具.json → display.columns）
DISPLAY_COLUMNS = [
...
def execute(
    ...
    """
    url = f"{BASE_URL}/v3/api/cashier-biz-manage/scenariokvs/type/paytool/names"
