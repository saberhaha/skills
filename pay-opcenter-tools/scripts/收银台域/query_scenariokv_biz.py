"""
场景KV-业务名单 — 查询场景KV业务名单列表
来源：schemas/收银台域/v3_场景KV业务.json
"""
import sys
import os
...
# 数据展示列（来源：v3_场景KV业务.json → display.columns）
DISPLAY_COLUMNS = [
...
def execute(
    ...
    """
    url = f"{BASE_URL}/v3/api/cashier-biz-manage/scenariokvs/type/biz/names"
