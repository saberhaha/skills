"""
场景KV-合作方ID名单 — 查询场景KV合作方ID名单列表
来源：schemas/收银台域/v3_场景KV合作方ID.json
"""
import sys
import os
...
# 入参 Schema（来源：v3_场景KV合作方ID.json）
PARAM_SCHEMA = {
...
# 数据展示列（来源：v3_场景KV合作方ID.json → display.columns）
DISPLAY_COLUMNS = [
...
def execute(
    ...
    """
    url = f"{BASE_URL}/v3/api/cashier-biz-manage/scenariokvs/type/partner-id/names"
