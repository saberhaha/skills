...
# 入参 Schema（来源：schemas/会计域/v1_负债报表.json）
PARAM_SCHEMA = {
    "queryOption": {
        "type": "string",
        "format": "YYYYMMDD",
...
# 数据展示列（来源：schemas/会计域/v1_负债报表.json display.columns）
DISPLAY_COLUMNS = [
...
def execute(
    ...
    """
    url = f"{BASE_URL}/dispatcher/accounting.liabilities.list"
