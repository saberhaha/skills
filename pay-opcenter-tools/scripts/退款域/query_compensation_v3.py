...
def execute(
    ...
    recovery_state: Optional[Literal["CREATED", "DISCARD", "BAD_DEBT", "REC_SUC"]] = None,
    ...
    Args:
        ...
        order_no: 订单编号。可选。
        out_biz_no: 处置业务单。可选。
        recovery_state: 追偿单状态。可选。枚举：CREATED=创建, DISCARD=已废弃, BAD_DEBT=坏账, REC_SUC=追偿成功。空=全部。
        ...
        desc: 排序是否降序。可选。
    """
    url = f"{BASE_URL}/v3/api/refund/compensate/searchData"
